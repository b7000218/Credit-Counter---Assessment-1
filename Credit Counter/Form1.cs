...
namespace Credit_Counter
{
    public partial class Form1 : Form
    {
        ...
        private void btn_1p_Buy_Click(object sender, EventArgs e)
        {
                ...
                OnePenceCount++;
                label_OnePenceCount.Text = OnePenceCount.ToString();

                int OnePenceValue = int.Parse(textBox_Total_Pence_Value.Text);
                OnePenceValue++;
                textBox_Total_Pence_Value.Text = OnePenceValue.ToString();
                ...
                textBox_Total_Pounds_Value.Text = OnePenceValue_InPounds.ToString();
